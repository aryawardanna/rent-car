                ...
                <div class="col-lg-10">
                    ...
                    <form class="trip-form" method="get" action="{{ route('car.index') }}">
                        <div class="row align-items-center">
                            ...
                            <div class="mb-3 mb-md-0 col-md-4">
                                <input type="submit" value="Cari" class="btn btn-success btn-block py-3" />
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row mb-5">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="step">
                        ...
                        <div class="step-inner">
                            <span class="number text-success">01.</span>
                            <h3>Pilih Mobil</h3>
                            <p>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="step">
                        <span>2</span>
                        <div class="step-inner">
                            <span class="number text-success">02.</span>
                            <h3>Isi Form</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                Vero, laboriosam!
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="step">
                        <span>3</span>
                        <div class="step-inner">
                            <span class="number text-success">03.</span>
                            <h3>Pembayaran</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                Vero, laboriosam!
