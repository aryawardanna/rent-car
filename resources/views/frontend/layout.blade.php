...
<body>
    <div class="site-wrap" id="home-section">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav ml-auto">
                                ...
                                <li><a href="{{ route('member.register') }}" class="btn btn-xs text-white btn-primary"
                                        style="padding: 12px 25px;">Register</a></li>
                                <li><a href="{{ route('member.login') }}" class="btn btn-xs text-white btn-success"
                                        style="padding: 12px 25px;">Login</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="site-section bg-success py-5">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 text-md-right">
                        <a href="#" class="btn btn-success btn-white">Sewa Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
